...
function M.setup(colors, config)
    ...
    if vim.fn.has('nvim-0.8.0') then
        ...
        hi['@comment.danger'] = 'DiagnosticError'
        hi['@comment.note'] = 'Tag'
        hi['@comment.todo'] = 'Todo'
        hi['@comment.warning'] = 'DiagnosticWarn'
        hi['@constant'] = 'TSConstant'
        hi['@constant.builtin'] = 'TSConstant'
        hi['@constant.macro'] = 'TSConstant'
        hi['@constructor'] = 'TSConstructor'
        hi['@diff.add'] = 'DiffAdd'
        hi['@diff.delete'] = 'DiffDelete'
        hi['@error'] = 'TSError'
        hi['@function'] = 'TSFunction'
        hi['@function.builtin'] = 'TSFuncBuiltin'
        hi['@function.call'] = 'TSFunction'
        hi['@function.macro'] = 'TSFuncMacro'
        hi['@function.method'] = 'TSMethod'
        hi['@function.method.call'] = 'TSMethod'
        hi['@keyword'] = 'TSKeyword'
        hi['@keyword.conditional'] = 'TSConditional'
        hi['@keyword.debug'] = 'Debug'
        hi['@keyword.directive'] = 'Define'
        hi['@keyword.directive'] = 'PreProc'
        hi['@keyword.exception'] = 'TSException'
        hi['@keyword.function'] = 'TSKeywordFunction'
        hi['@keyword.import'] = 'TSInclude'
        hi['@keyword.operator'] = 'TSKeywordOperator'
        hi['@keyword.repeat'] = 'TSRepeat'
        hi['@keyword.return'] = 'TSKeyword'
        hi['@keyword.storage'] = 'StorageClass'
        hi['@label'] = 'TSLabel'
        hi['@markup.emphasis'] = 'TSEmphasis'
        hi['@markup.heading'] = 'TSTitle'
        hi['@markup.link.label'] = 'SpecialChar'
        hi['@markup.link.url'] = 'TSUri'
        hi['@markup.list'] = 'TSPunctSpecial'
        hi['@markup.raw'] = 'TSLiteral'
        hi['@markup.strike'] = 'TSStrike'
        hi['@markup.strong'] = 'TSStrong'
        hi['@markup.underline'] = 'TSUnderline'
        hi['@module'] = 'TSNamespace'
        hi['@none'] = 'TSNone'
        hi['@number'] = 'TSNumber'
        hi['@number.float'] = 'TSFloat'
        ...
        hi['@string.regexp'] = 'TSStringRegex'
        hi['@string.special.symbol'] = 'TSSymbol'
        hi['@tag'] = 'TSTag'
        ...
        hi['@variable.parameter'] = 'TSParameter'
    end
